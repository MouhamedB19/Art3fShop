...
return new class extends Migration
{
    ...
    {
        Schema::create('campagne_pub', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('emplacement_id')->references('code')->on('emplacements_pubs')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('campagne_pub');
    }
};
