...
@section('breadcrumb')
    <a href="{{ route('home') }}" class="hover:text-[#1A1A1A] transition-colors">Accueil</a>
    <x-mini-fleche/>
            ...
            <section>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <x-text-input-art3f type="text" name="nom" value="{{old('nom',$user->nom)}}"/>
                    ...
                    <div>
                        ...
                        <x-text-input-art3f type="text" name="prenom" value="{{ old('prenom',$user->prenom) }}"/>
                        @error('prenom') <p class="text-xs text-red-500 mt-1">{{ $message }}</p> @enderror
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1" for="email">Email</label>
                        <x-text-input-art3f type="email" name="email" value="{{ old('email',$user->email) }}" />
                        @error('email') <p class="text-xs text-red-500 mt-1">{{ $message }}</p> @enderror
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1" for="nom_d_artiste">Nom d'artiste</label>
                        <x-text-input-art3f type="text" name="nom_d_artiste" value="{{ old('nom_d_artiste',$artiste->nom_d_artiste) }}"/>
            ...
            <section>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <x-text-input-art3f type="password" name="password"
                               message="Laisser vide pour ne pas changer"/>
                    ...
                    <div>
                        ...
                        <x-text-input-art3f type="password" name="password_confirmation"/>
                    </div>
