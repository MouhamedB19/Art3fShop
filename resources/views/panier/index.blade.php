        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 flex flex-col gap-4">
                @foreach($tirages as $tirage)
                    <div class="border border-gray-200 rounded-2xl p-5 flex gap-5 items-start hover:border-[#E8490F] transition-all">

                        {{-- Image de l'œuvre --}}
                        <div class="w-24 h-24 rounded-xl overflow-hidden bg-gray-100 shrink-0">
                            @if($tirage->oeuvre->image)
                                <img src="{{ Storage::url($tirage->oeuvre->image) }}"
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-500 mb-1">
                                par {{ $tirage->oeuvre->artiste->user->name }}
                            </p>
                            <p class="text-xs text-gray-400">
                                Tirage n°{{ $tirage->numero }}
                                @if($tirage->encadrement) · Avec encadrement @endif
                            </p>
                        </div>
            ...
            <div class="border border-gray-200 rounded-2xl p-6 h-fit sticky top-6">
                ...
                <a href="{{ route('commandes.checkout') }}"
